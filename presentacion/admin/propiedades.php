            ...
            <div style="padding: 3rem 4rem;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 2rem;">
                    <div class="kpi-card" style="padding: 2rem;">
                        ...
                        <div style="font-size: 2.25rem; font-weight: 800; margin: 0.5rem 0; color: #1e293b;">128</div>
                    ...
                    <div class="kpi-card" style="padding: 2rem;">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1rem;">
                            <a href="#" style="font-size: 12px; font-weight: 800; color: #1e40af; text-decoration: none;">Ver reporte detallado</a>
                            <i class="fa-solid fa-arrow-right" style="color: #1e40af; font-size: 12px;"></i>
                        </div>
                    </div>
                </div>
            </div>
