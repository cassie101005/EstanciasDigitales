...
<head>
    ...
    <link rel="stylesheet" href="../../recursos/css/admin/main.css"> <!-- Reusing some base components like tables -->
            ...
            <div style="padding: 2.5rem 4rem; max-width: 1600px; margin: 0 auto;">
                ...
                <section class="kpi-host-grid">
                    ...
                    <div class="kpi-host-card">
                        ...
                        <div class="value">4.9 <i class="fa-solid fa-star" style="color: #1e40af; font-size: 1rem;"></i></div>
                    </div>
                    <div class="kpi-host-card">
                ...
                <section class="admin-table-container" style="border-radius: 1.5rem; margin-top: 2rem;">
                    <div style="padding: 2rem; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #f1f5f9; flex-wrap: wrap; gap: 1.5rem;">
                        <h3 style="font-size: 1.25rem; font-weight: 800; color: #1e293b;">Reservas Recientes</h3>
                        <div style="display: flex; gap: 1rem; font-size: 12px; font-weight: 800;">
                            <span style="color: white; background: #1e40af; padding: 8px 16px; border-radius: 99px; cursor: pointer;">Todas</span>
                                ...
                                <tr>
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 1rem;">
                                            ...
                                            <div>
                                                <div style="font-size: 14px; font-weight: 800; color: #1e293b;">Elena Rodríguez</div>
                                                <div style="font-size : 11px; color: #64748b; font-weight: 600;">Súper Huésped • 12 estancias</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="font-size: 14px; font-weight: 700; color: #1e293b;">Villa Mediterránea</div>
                                        <div style="font-size: 11px; color: #94a3b8; font-weight: 600;">Alicante, ES</div>
                                    </td>
                                    <td>
                                        <div style="font-size: 14px; font-weight: 700; color: #1e293b;">12 May - 18 May</div>
                                    ...
                                    <td><strong style="font-size: 15px; color: #1e40af;">€1,240.00</strong></td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 1rem;">
                                            ...
                                            <div>
                                                <div style="font-size: 14px; font-weight: 800; color: #1e293b;">Marco Jansen</div>
                                                <div style="font-size : 11px; color: #64748b; font-weight: 600;">Huésped Nuevo</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="font-size: 14px; font-weight: 700; color: #1e293b;">Loft Industrial</div>
                                        <div style="font-size: 11px; color: #94a3b8; font-weight: 600;">Madrid, ES</div>
                                    </td>
                                    <td>
                                        <div style="font-size: 14px; font-weight: 700; color: #1e293b;">05 May - 08 May</div>
                                    ...
                                    <td><strong style="font-size: 15px; color: #1e293b;">€450.00</strong></td>
                                    <td>
                                        <button style="border: none; background: #f1f5f9; padding: 8px; border-radius: 8px; color: #64748b; cursor: pointer;">
                                            <i class="fa-solid fa-ellipsis"></i>
                                        </button>
                ...
                <section style="margin-top: 5rem;">
                    <header style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 3rem; flex-wrap: wrap; gap: 1.5rem;">
                         <div>
                            <h2 style="font-size: 2rem; font-weight: 800; color: #1e293b; letter-spacing: -1px;">Reseñas de Huéspedes</h2>
                        ...
                        <div style="display: flex; align-items: center; gap: 0.5rem; color: #1e40af; font-weight: 800; background: #f0f4ff; padding: 10px 20px; border-radius: 12px;">
                        ...
                        <div class="review-card">
                            <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem;">
                                <div style="display: flex; gap: 1rem;">
                                    ...
                                    <div>
                                        <div style="font-size: 15px; font-weight: 800; color: #1e293b;">Lucía Méndez</div>
                                        <div style="font-size: 12px; color: #94a3b8; font-weight: 600;">Villa Mediterránea • Abril 2024</div>
                                    </div>
                                </div>
                                <div style="color: #1e40af; font-size: 12px; display: flex; gap: 2px;">
                            ...
                            <div style="text-align: right; border-top: 1px solid #f1f5f9; padding-top: 1.5rem;">
                                <a href="#" style="font-size: 13px; font-weight: 800; color: #1e40af; text-decoration: none; display: inline-flex; align-items: center; gap: 8px;">Responder comentario <i class="fa-solid fa-reply"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="review-card">
                            <div style="display: flex; justify-content: space-between; margin-bottom: 1.5rem;">
                                <div style="display: flex; gap: 1rem;">
                                    ...
                                    <div>
                                        <div style="font-size: 15px; font-weight: 800; color: #1e293b;">Thomas Müller</div>
                            ...
                            <div style="background: #f8fafc; padding: 1.5rem; border-radius: 16px; border: 1px solid #f1f5f9;">
                                <div style="font-size: 11px; font-weight: 800; text-transform: uppercase; color: #1e40af; margin-bottom: 0.75rem; letter-spacing: 0.5px;">Tu respuesta</div>
