...
<head>
    <meta charset="UTF-8">
    <title>Todas mis notificaciones | Estancias Digitales</title>
...
<body class="body-surface">
    ...
    <div class="notif-page-container">
        <h1 style="font-size: 2.5rem; font-weight: 800; margin-bottom: 2rem; letter-spacing: -1px;">Notificaciones</h1>
        ...
        <?php foreach ($notificaciones as $n): ?>
            <?php 
                ...
                switch($tipo) {
                    ...
                    case 'resena_recibida': $color = "#f59e0b"; $icon = "fa-star"; $bg = "#fef3c7"; break;
                }
        ...
        <?php if (empty($notificaciones)): ?>
            <div style="text-align: center; padding: 5rem 0;">
                ...
                <p style="font-size: 1.2rem; color: #94a3b8; font-weight: 600;">Aún no tienes notificaciones.</p>
            </div>
        <?php endif; ?>
    </div>

    <script src="../../recursos/js/huesped/notificaciones.js"></script>
</body>
</html>
